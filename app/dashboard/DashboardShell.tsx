...
export default function DashboardShell({
  ...
  const Sidebar = ({ mobile = false }: { mobile?: boolean }) => (
    <aside
      className={`sidebar-gradient flex flex-col ${
    ...
    >
      ...
      <div className="p-3 border-t border-white/10 space-y-1">
        ...
        <div className="mt-1 flex items-center gap-3 rounded-xl bg-white/8 px-3 py-2.5 backdrop-blur-sm">
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-indigo-400 to-violet-500 text-xs font-bold text-white shadow-md">
            {initials(userName)}
          </div>
  ...
  return (
    <div className="dashboard-light dash flex h-screen w-full overflow-hidden" style={{ background: "#f4f6fa" }}>
      {/* Sidebar — desktop */}
      <Sidebar />
